# class Request:
#     "arrivals and processing times"
#     def __init__(self,arrival_time,process_time):
#         self.arrival_time = arrival_time
#         self.process_time = process_time
#
# class Response:
#     "isdropped and starting time"
#     def __init__(self,isdropped,start_time):
#         self.isdropped = isdropped
#         self.start_time = start_time
#
# class Buffer:
#     "Deletes processed data and processes the data based on buffer size"
#     def __init__(self,size):
#         self.size = size
#         self.end_time = []
#
#     def delete_processed_data(self,request):
#         while self.end_time :
...
#
#         self.delete_processed_data(request)
#
#         if len(self.end_time) == self.size:
...
#         self.end_time.append(self.end_time[-1]+request.arrival_time)
#         return response
#
...
#     return [buffer.Process_data(r) for r in requests]
#
# def print_requests(responses):
#     for response in responses:
#         print(response.start_time if not response.isdropped else -1)
#
